...
function uplaodFiles (event, tableId){
    ...
    if(currentFileUpload && currentFileUpload.files && currentFileUpload.files.length > 0){
    ...
    reader.onload = function(event){
        ...
        const ifFirstRowEmpty = firstRow.every(cell => cell === '' || cell === null);
        ...
        textDisapear('Billing Data Sucseesfuly Proceseed!<br>Please uplaod Roster File', 'rgba(1, 180, 1, 0.849)')
    ...
    populateRoster(table1data, table2data)
            textDisapear('Roster Data has been Sucssesfuly Uploaded, <br>Please hang on while we return the data', 'green')
...
console.log(`Name-Match found in table 2 data found in table 1 data: ${matchedNames}`)
